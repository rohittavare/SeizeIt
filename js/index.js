...
databaseURL: 
"https://seizeit-cdb9a.firebaseio.com", storageBucket: "seizeit-cdb9a.appspot.com"/*GO VBshdukfsadkjgfhgsadkjfhksdahfjkashdjghdfawe*/,
};
...
window.onload = function() {$(".button-collapse").sideNav();document
.getElementById("signOut").addEventListener('click',function () {if(firebase.auth().currentUser){firebase.auth().signOut();}});}